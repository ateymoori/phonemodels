...
Also, I'm using GitHub Actions as CI/CD. As I defined before, If I push the codes into any branch except master/release, All tests will run, Then If all of them pass, one APK will be built and uploaded into the Github actions artifact.
